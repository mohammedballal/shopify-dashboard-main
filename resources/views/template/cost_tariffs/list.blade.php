@extends("template.layouts.master",['page_title'=>"Cost & Tariff List"])
@section("vendorCss")
    <!-- BEGIN: Vendor CSS-->
        ...
        <section class="app-shop-list">
            ...
            <div class="card p-2">
                ...
                <!-- Modal to add new shop starts-->
                    @include('template.layouts.views.addCostTariff')
...
{{--    <script src="{{ asset("app-assets/js/scripts/pages/app-user-list.js")}}"></script>--}}
    ...
    <script>
        function editShop(id) {
            let url = window.location.origin+'/costtariff/'+id+'/edit';
            fetch(url)
                .then(response => response.json())
                .then(json =>{
                    console.log(json);
                    url = window.location.origin+'/costtariff/update/'+json.id;
        ...
        $(function () {
            ...
            if (dtshopTable.length) {
                dtshopTable.DataTable({
                    ajax: "{{ route("costtariff.index") }}", // JSON file to add data
                    columns: [
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, full, meta) {
                                var destroy = "/costtariff/destroy/"+full['id'];
                                var edit = full['id'];
                                return (
                                    '<div class="btn-group">' +
