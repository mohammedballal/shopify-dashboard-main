                                ...
                                <div class="mt-md-0 mt-2">
                                    ...
                                    <div class="invoice-date-wrapper">
                                        ...
                                        @if($order->fulfillment_status == "fulfilled")
                                            <p class="invoice-date badge badge-pill text-capitalized btn btn-sm rounded-pill btn-success">{{ strtoupper($order->fulfillment_status) }}</p>
                                        @else
                                            <p class="invoice-date badge badge-pill text-capitalized btn btn-sm rounded-pill btn-warning">{{ strtoupper($order->fulfillment_status) }}</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
...
{{--                                </div>--}}
                ...
                <div class="{{ $invoice_route?'':'d-none' }} col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('order.invoice.download',$order->id)}}" class="btn btn-outline-secondary btn-block btn-download-invoice mb-75">Download</a>
                            <a class="btn btn-outline-secondary btn-block mb-75" {{--id="printInvoice"--}} href="{{ route("order.invoice.print",$order->id) }}" target="_blank">
                                Print
                            </a>
                        </div>
                    </div>
        ...
        <!-- Send Invoice Sidebar -->
            @include('template.layouts.views.sendInvoice')
        <!-- /Send Invoice Sidebar -->
