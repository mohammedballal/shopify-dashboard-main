                            ...
                            <form class="" method="post" action="{{ route("users.update") }}" id="user_edit_form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 d-none" id="tagIdSection">
                                        <div class="form-group">
                                            <label class="form-label" for="basic-icon-default-tag_id">Tag ID</label>
                                            <input type="number" id="basic-icon-default-tag_id" class="form-control dt-uname" min="0" placeholder="{{rand(1000000000,9999999999)}}" aria-label="{{rand(1000000000,9999999999)}}" aria-describedby="basic-icon-default-uname2" value="{{old('tag_id')?old("tag_id"):$user->tag_id}}" name="tag_id" />
                                            @error('tag_id')
                                            <span class="error">{{ucwords($message)}}</span>
                                            @enderror
                                        </div>
