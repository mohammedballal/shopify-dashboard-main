@extends("template.layouts.master",['page_title'=>"Systems Blocked / White-listed IPs List"])
@section("vendorCss")
    <!-- BEGIN: Vendor CSS-->
    ...
    <script>
        $(function () {
            ...
            var dtUserTable = $('.user-list-table'),
                ...
                statusObj = {
                    "Whitelist": {title: 'Whitelist', class: 'badge-light-secondary' },
                    "Un-Blocked": {title: 'Un-Blocked', class: 'badge-light-success' },
                    "Blocked": {title: 'Blocked', class: 'badge-light-danger' }
                };
            ...
            if (dtUserTable.length) {
                dtUserTable.DataTable({
                    ajax: "{{ route("ip.list") }}", // JSON file to add data
                    columns: [
                    ...
                    initComplete: function () {
                        ...
                        this.api()
                            ...
                            .every(function () {
                                var column = this;
                                var select = $(
                                    '<select id="FilterTransaction" class="form-control text-capitalize mb-md-0 mb-2xx"><option value=""> Select IP Status </option></select>'
                                )
