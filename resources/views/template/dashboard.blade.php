@extends("template.layouts.master",['page_title'=>env("APP_STORE_NAME")." Store Dashboard"])
@section("pageCss")
    <!-- BEGIN: Page CSS-->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <!-- column -->
                            <div class="col-lg-3">
                                <h1 class="m-b-0 m-t-30">${{auth()->user()->sales()}}</h1>
                                <h6 class="font-light text-muted">Current Month Earnings</h6>
                                <h3 class="m-t-30 m-b-0">{{auth()->user()->products()}}</h3>
                                    ...
                                    <div class="media">
                                        <div class="avatar bg-light-primary mr-2">
                                            <div class="avatar-content">
                                                <i data-feather="trending-up" class="avatar-icon icon"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                    <div class="media">
                                        <div class="avatar bg-light-info mr-2">
                                            <div class="avatar-content">
                                                <i data-feather="user" class="avatar-icon icon"></i>
                                            </div>
                                        </div>
                                        <div class="media-body my-auto">
                                ...
                                <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                    <div class="media">
                                        <div class="avatar bg-light-danger mr-2">
                                            <div class="avatar-content">
                                                <i data-feather="box" class="avatar-icon icon"></i>
                                            </div>
                                        </div>
                                        <div class="media-body my-auto">
                                ...
                                <div class="col-xl-3 col-sm-6 col-12">
                                    <div class="media">
                                        <div class="avatar bg-light-success mr-2">
                                            <div class="avatar-content">
                                                <i data-feather="dollar-sign" class="avatar-icon icon"></i>
                                            </div>
                                        </div>
                                        <div class="media-body my-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar bg-light-primary mr-1">
                                                    <div class="avatar-content">
                                                        <i data-feather="monitor" class="font-medium-3 icon"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <i data-feather="trending-down" class="text-danger icon font-medium-1"></i>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar bg-light-success mr-1">
                                                    <div class="avatar-content">
                                                        <i data-feather="coffee" class="font-medium-3 icon"></i>
                                                    </div>
                                                </div>
                                                <span>Grocery</span>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <i data-feather="trending-up" class="text-success font-medium-1 icon"></i>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar bg-light-warning mr-1">
                                                    <div class="avatar-content">
                                                        <i data-feather="watch" class="font-medium-3 icon"></i>
                                                    </div>
                                                </div>
                                                <span>Fashion</span>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <i data-feather="trending-up" class="text-success icon font-medium-1"></i>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="card-body">
                            ...
                            <div class="media">
                                <div class="avatar bg-light-primary rounded mr-1">
                                    <div class="avatar-content">
                                        <i data-feather="calendar" class="avatar-icon font-medium-3 icon"></i>
                                    </div>
                                </div>
                            ...
                            <div class="media mt-2">
                                <div class="avatar bg-light-primary rounded mr-1">
                                    <div class="avatar-content">
                                        <i data-feather="map-pin" class="avatar-icon font-medium-3 icon"></i>
                                    </div>
                                </div>
                                <div class="media-body">
                    ...
                    <div class="card card-browser-states">
                        <div class="card-header">
                            ...
                            <div class="dropdown chart-dropdown">
                                <i data-feather="more-vertical" class="font-medium-3 cursor-pointer icon" data-toggle="dropdown"></i>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <i data-feather="help-circle" class="font-medium-3 text-muted cursor-pointer icon"></i>
                        </div>
                        <div class="card-body p-0">
                            ...
                            <div class="transaction-item">
                                <div class="media">
                                    <div class="avatar bg-light-primary rounded">
                                        <div class="avatar-content">
                                            <i data-feather="pocket" class="avatar-icon font-medium-3 icon"></i>
                                        </div>
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="transaction-item">
                                <div class="media">
                                    <div class="avatar bg-light-success rounded">
                                        <div class="avatar-content">
                                            <i data-feather="check" class="avatar-icon font-medium-3 icon"></i>
                                        </div>
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="transaction-item">
                                <div class="media">
                                    <div class="avatar bg-light-danger rounded">
                                        <div class="avatar-content">
                                            <i data-feather="dollar-sign" class="avatar-icon font-medium-3 icon"></i>
                                        </div>
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="transaction-item">
                                <div class="media">
                                    <div class="avatar bg-light-warning rounded">
                                        <div class="avatar-content">
                                            <i data-feather="credit-card" class="avatar-icon font-medium-3 icon"></i>
                                        </div>
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="transaction-item">
                                <div class="media">
                                    <div class="avatar bg-light-info rounded">
                                        <div class="avatar-content">
                                            <i data-feather="trending-up" class="avatar-icon font-medium-3 icon"></i>
                                        </div>
                                    </div>
                                    <div class="media-body">
    ...
    <script>
        ...
        function getData(data) {
            ...
            $.each(data, function (i, elem) {
                dataFromBackend.push({X:elem.order_date,Y:elem.total_usd});
            });
           ...
           return  seriesData.sort((a, b) => new Date(a.x).getTime() - new Date(b.x).getTime());
        }
