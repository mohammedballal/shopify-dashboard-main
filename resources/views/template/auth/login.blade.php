...
<head>
    ...
    <title>Login Page - Shopify Dashboard</title>
            ...
            <div class="auth-wrapper auth-v2">
                <div class="auth-inner row m-0">
                    <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                        ...
                        <h2 class="brand-text text-primary ml-1">Shopify</h2>
                    </a>
                    <!-- /Brand logo-->
                    <!-- Left Text-->
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            @if(!empty(env("APP_STORE_NAME")))
                            <h2 class="card-title font-weight-bold mb-1">Welcome to {{ env("APP_STORE_NAME") }}</h2>
                            @endif
                            ...
                            <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="login-email" type="text" value="{{ old("email") }}" name="email" placeholder="john@example.com" aria-describedby="login-email" autofocus="" tabindex="1" />
                                </div>
                                <div class="form-group">
