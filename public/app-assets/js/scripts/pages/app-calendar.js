...
function setColorTClass(colorName) {
    // console.log("1")
    $(".custom-bg-light-"+colorName).css({
        'background-color': colorName.replace('-','#'),
        'color': '#FFFFFF',
    })
}
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (eventLabel.length) {
    function renderBullets(option) {
      ...
      var $bullet =
        "<span class='bullet bullet-sm mr-50' style='background-color: "+$(option.element).data('label')+"!important;'>" +
        '</span>' +
        option.text;
  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    eventClassNames: function ({ event: calendarEvent }) {
      ...
      setColorTClass(colorName);
      return [
        // Background Color
        'custom-bg-light-' + colorName
      ];
    },
    //   eventColor:calendarsColor[event.extendedProps.calendar],
